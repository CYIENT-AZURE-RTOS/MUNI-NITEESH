...
extern volatile uint8_t exti_pin=0;
/* USER CODE END PV */
...
UINT App_ThreadX_Init(VOID *memory_ptr)
{
  ...
  CHAR *pointer,*pointer2;
    ...
    tx_semaphore_create(&sem_pointer,"sem pointer",1);
...
void ThreadOne_Entry(ULONG thread_input)
{
  ...
  {
	  tx_semaphore_get(&sem_pointer,1);
