	 ...
	 // tx_mutex_get(&uart_pointer,TX_WAIT_FOREVER);
	  ...
	  if(tx_success==status)
	  {
		  if(threadcount<=2)
		  {
			...
			if(tx_success==status)
			{
				HAL_UART_Transmit(&huart1,"\n\r******* thread one function Terminated*****\n\r",43, 100);
				status=tx_thread_delete(&ThreadOne);
				if(tx_success==status)
				{
				HAL_UART_Transmit(&huart1,"\n\r******* thread one function DELETE*****\n\r",48, 100);
			}
		   }
		  }
...
//	  if(threadcount<=2)
//	  {
//		status=tx_thread_terminate(&ThreadTwo);
//		if(tx_success==status)
//		{
//			HAL_UART_Transmit(&huart1,"\n\r******* thread two function Terminated*****\n\r",43, 100);
//			status=tx_thread_delete(&ThreadOne);
//			if(tx_success==status)
//			{
//			HAL_UART_Transmit(&huart1,"\n\r******* thread two function DELETE*****\n\r",48, 100);
//		}
//	   }
//	  }
...
//			  if(threadcount<=2)
//			  {
//				status=tx_thread_delete(&Threadthree);
//				if(tx_success==status)
//				{
//					HAL_UART_Transmit(&huart1,"\n\r******* thread one function DELETE*****\n\r",48, 100);
//				}
...
//			  if(threadcount<=2)
//			  {
//				status=tx_thread_delete(&Threadfour);
//				if(tx_success==status)
//				{
//					HAL_UART_Transmit(&huart1,"\n\r******* thread one function DELETE*****\n\r",48, 100);
//				}
